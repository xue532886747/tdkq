package com.example.towerdriver.staff.staff_person.ui.activity;
...
import com.example.towerdriver.staff.staff_person.presenter.StaffCenterPresenter;
 ...
 * @date 2021/7/6
 */
public class StaffCenterActivity extends BaseActivity<StaffCenterPresenter> implements StaffCenterView, BaseActivity.PermissionListener {
    ...
    @Override
    protected StaffCenterPresenter createPresenter() {
        return new StaffCenterPresenter(this);
    }
    ...
    protected void initData() {
        cl_coin.setVisibility(View.GONE);
    }
