 ...
 * @date 2021/5/31
 */
public class SystemNoticeFragment extends BaseFragment<SystemNoticePresenter> implements ISystemNoticeView {
        ...
        mAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull BaseQuickAdapter<?, ?> adapter, @NonNull View view, int position) {
                NoticeBean.NoticeListBean noticeListBean = mAdapter.getData().get(position);
                 MyWebViewActivity.launch(getActivity(), false, noticeListBean.getTitle(), noticeListBean.getUrl());
                if (presenter != null) {
                    presenter.getChangeNotice(String.valueOf(noticeListBean.getId()), "1", position);
                }
            }
        });
