...
import com.example.towerdriver.base_rescue.ui.activity.RescueDetailActivity;
 ...
 * @date 2021/5/31
 */
public class RescueNoticeFragment extends BaseFragment<SystemNoticePresenter> implements ISystemNoticeView {
    ...
    public static RescueNoticeFragment newInstance() {
        return new RescueNoticeFragment();
    }
    ...
    protected void initData() {
        ...
        mAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull BaseQuickAdapter<?, ?> adapter, @NonNull View view, int position) {
                ...
                if (presenter != null) {
                    presenter.getChangeNotice(String.valueOf(noticeListBean.getId()), "2", position);
                }
