package com.example.towerdriver.repair.base.activity;
...
import com.example.towerdriver.repair.base_mine.ui.fragment.RepairMainFragment;
import com.example.towerdriver.repair.base_order.ui.fragment.RepairOrderListFragment;
import com.example.towerdriver.repair.base_warehouse.ui.fragment.RepairWarehouseFragment;
 ...
 * @date 2021/7/4
 */
public class RepairMainActivity extends BaseActivity<StationMainPresenter> implements StationMainView {
    ...
    private RepairOrderListFragment mOrderListFragment;
    private RepairWarehouseFragment mRescueListFragment;
    private RepairMainFragment mineFragment;
    ...
    protected int getLayoutId() {
        return R.layout.act_repair_main;
    }
    ...
    protected void initData() {
        mOrderListFragment = RepairOrderListFragment.newInstance();
        mRescueListFragment = RepairWarehouseFragment.newInstance();
        mineFragment = RepairMainFragment.newInstance();
        ...
        try {
            ...
            if (my_versionName < my_update_version) {
                new UpdateDialog(this).Builder(null, versionName, version.getVersion(),version.getContent()).setDialogClickListener(new UpdateDialog.DialogClickListener() {
                    @Override
                    public void bottom() {
                        goToAppMarket(RepairMainActivity.this);
                    }
