package com.example.towerdriver.repair.base_mine.ui.fragment;
 ...
 * @date 2021/7/4
 */
public class RepairMainFragment extends BaseFragment  {
    ...
    public static RepairMainFragment newInstance() {
        ...
        switch (v.getId()) {
            case R.id.cl_change_phone:
                if (!RepeatClickResolveUtil.isFastDoubleClick(R.id.cl_change_phone)) {
                    Intent intent = new Intent(getActivity(), RepairCenterActivity.class);
