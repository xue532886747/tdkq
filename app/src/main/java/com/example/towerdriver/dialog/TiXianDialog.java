...
public class TiXianDialog {
    ...
    public TiXianDialog setDialogClickListener(DialogClickListener dialogClickListener) {
            ...
            bt_commit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (dialogClickListener != null) {
                        dialogClickListener.getTiXianMoney(Objects.requireNonNull(et_phone.getText()).toString());
                    }
                    cancle();
                }
            });
    ...
    public interface DialogClickListener {
        ...
        void getTiXianMoney(String content);
    }
