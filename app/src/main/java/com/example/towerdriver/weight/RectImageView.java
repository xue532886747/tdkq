...
public class RectImageView extends AppCompatImageView {
    ...
    public RectImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < ta.getIndexCount(); i++) {
            ...
            } else if (attr == R.styleable.NiceImageView_corner_new_radius) {
    ...
    public void setBorderWidth(int borderWidth) {
        this.borderWidth = (int) DisPlayUtils.dp2px(borderWidth);
    ...
    public void setInnerBorderWidth(int innerBorderWidth) {
        this.innerBorderWidth = (int) DisPlayUtils.dp2px(innerBorderWidth);
        clearInnerBorderWidth();
        invalidate();
    }
    ...
    public void setCornerRadius(int cornerRadius) {
        this.cornerRadius = (int) DisPlayUtils.dp2px(cornerRadius);
        calculateRadiiAndRectF(false);
    }

    public void setCornerTopLeftRadius(int cornerTopLeftRadius) {
        this.cornerTopLeftRadius = (int) DisPlayUtils.dp2px(cornerTopLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerTopRightRadius(int cornerTopRightRadius) {
        this.cornerTopRightRadius = (int) DisPlayUtils.dp2px(cornerTopRightRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomLeftRadius(int cornerBottomLeftRadius) {
        this.cornerBottomLeftRadius = (int) DisPlayUtils.dp2px(cornerBottomLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomRightRadius(int cornerBottomRightRadius) {
        this.cornerBottomRightRadius = (int) DisPlayUtils.dp2px(cornerBottomRightRadius);
        calculateRadiiAndRectF(true);
    }
