...
public class SmartRefreshUtils {
    ...
    public SmartRefreshUtils setRefreshListener(@NotNull RefreshListener refreshListener) {
        ...
        if (refreshListener == null) {
            ...
            mRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
                ...
                public void onRefresh(@NotNull RefreshLayout refreshLayout) {
                    refreshLayout.finishRefresh((int) FreeApi.Config.HTTP_TIMEOUT, false, false);
        ...
        if (loadMoreListener == null) {
            ...
            mRefreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
                ...
                public void onLoadMore(@NotNull RefreshLayout refreshLayout) {
                    refreshLayout.finishLoadMore((int) FreeApi.Config.HTTP_TIMEOUT);
