package com.example.base_ui.file_picker.activity;
...
import com.example.base_ui.file_picker.adapter.BreadAdapter;
import com.example.base_ui.file_picker.adapter.FileListAdapter;
import com.example.base_ui.file_picker.adapter.SelectSdcardAdapter;
import com.example.base_ui.file_picker.model.BreadModel;
import com.example.base_ui.file_picker.model.EssFile;
import com.example.base_ui.file_picker.model.EssFileCountCallBack;
import com.example.base_ui.file_picker.model.EssFileListCallBack;
import com.example.base_ui.file_picker.task.EssFileCountTask;
import com.example.base_ui.file_picker.task.EssFileListTask;
import com.example.base_ui.file_picker.util.Const;
import com.example.base_ui.file_picker.util.FileUtils;
...
public class SelectFileByBrowserActivity extends AppCompatActivity
        implements View.OnClickListener, EssFileListCallBack, EssFileCountCallBack, FileListAdapter.onLoadFileCountListener, OnItemClickListener {
...
//        EventBus.getDefault().register(this);
    ...
    private void initUi() {
        ...
        mBreadAdapter.addChildClickViewIds(R.id.btn_bread);
    ...
    private void showPopupWindow() {
        ...
        adapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull BaseQuickAdapter<?, ?> adapter, @NonNull View view, int position) {
                ...
                executeListTask(mSelectedFileList, FileUtils.getChangeSdCard((String) adapter.getData().get(position), mSdCardList),
