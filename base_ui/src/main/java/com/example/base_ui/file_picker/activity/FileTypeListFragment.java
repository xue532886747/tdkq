...
import com.example.base_ui.file_picker.BaseFileFragment;
import com.example.base_ui.file_picker.SelectOptions;
import com.example.base_ui.file_picker.adapter.FileListAdapter;
import com.example.base_ui.file_picker.loader.EssMimeTypeCollection;
import com.example.base_ui.file_picker.model.EssFile;
import com.example.base_ui.file_picker.model.FileScanActEvent;
import com.example.base_ui.file_picker.model.FileScanFragEvent;
import com.example.base_ui.file_picker.model.FileScanSortChangedEvent;
...
public class FileTypeListFragment extends BaseFileFragment implements
        EssMimeTypeCollection.EssMimeTypeCallbacks, OnItemClickListener {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (getUserVisibleHint()) {
            if (!isFirstLoad && mSortTypeHasChanged) {
                ...
                mAdapter.setList(new ArrayList<EssFile>());
                mAdapter.setEmptyView(R.layout.loading_layout);
                mMimeTypeCollection.load(mFileType, mSortType, mLoaderId);
            }
        }
