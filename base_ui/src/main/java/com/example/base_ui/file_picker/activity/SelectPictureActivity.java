...
import com.example.base_ui.file_picker.adapter.BuketAdapter;
import com.example.base_ui.file_picker.adapter.EssMediaAdapter;
import com.example.base_ui.file_picker.loader.EssAlbumCollection;
import com.example.base_ui.file_picker.loader.EssMediaCollection;
import com.example.base_ui.file_picker.model.Album;
...
import com.example.base_ui.file_picker.widget.MediaItemDecoration;
import com.example.base_ui.file_picker.widget.ToolbarSpinner;
...
//        EventBus.getDefault().register(this);
    ...
    private void initUI() {
        ...
        mMediaAdapter.setImageResize(UiUtils.getImageResize(mRecyclerView));
        mRecyclerView.setAdapter(mMediaAdapter);
        mMediaAdapter.addChildClickViewIds(R.id.capture, R.id.check_view, R.id.media_thumbnail);
