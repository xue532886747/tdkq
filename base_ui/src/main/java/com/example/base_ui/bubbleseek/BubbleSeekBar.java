package com.example.base_ui.bubbleseek;
...
import static com.example.base_ui.bubbleseek.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.example.base_ui.bubbleseek.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.example.base_ui.bubbleseek.BubbleSeekBar.TextPosition.SIDES;
import static com.example.base_ui.bubbleseek.BubbleUtils.dp2px;
import static com.example.base_ui.bubbleseek.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_track_size, dp2px(3));
        ...
        mTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_track_color,
                ContextCompat.getColor(context, R.color.main_light_color));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isShowTextBelowSectionMark || isShowSectionMark) {
            ...
            for (int i = 0; i <= mSectionCount; i++) {
                ...
                // sectionMark
                canvas.drawCircle(x_, yTop, r + dp2px(1), mPaint);
        ...
        if (check(mThumbCenterX, xLeft)) {
            canvas.drawCircle(mThumbCenterX, yTop, (mThumbRadiusOnDragging - dp2px(2)) / 2f, mPaint);
        }
    }

    private boolean check(float mThumbCenterX, float left) {
        for (int i = 0; i <= mSectionCount; i++) {
            float x_ = left + i * mSectionOffset;
            if (mThumbCenterX == x_) {
                return true;
            }
        }
